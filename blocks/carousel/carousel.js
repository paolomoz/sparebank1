...
/**
 * carousel — the live guide-carousel (collection pattern): one row per slide [screenshot][title + copy][slide name].
 * Variant `guide` (layout1: phone screenshots 250px column left, 470px copy right, 495px tall slides ≥768; frost/sand tint via
 * the section). One slide visible; "N av M" counter + Forrige/Neste secondary pills are block chrome (fixed strings, like the
 * accordion's "Åpne"); the slide names (authored, visually hidden on live) feed the tablist. Authored nodes are moved (EW1).
 */
