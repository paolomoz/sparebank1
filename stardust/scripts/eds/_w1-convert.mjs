...
for (const f of ["category-hub.mjs", "kundeservice-hub.mjs", "market-landing.mjs"]) Object.assign(ENCODERS, (await import(path.join(encDir, f))).default || {}); // _w1: W1 family files re-applied last (family-gated inside; see eds-requests.md)
